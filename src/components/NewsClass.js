...
export default class NewsClass extends Component {
  articles = [
    {
      ...
      description:
        'Comedian Pete Davidson claimed he\'s been "harassed" about his past relationships due to his appearance. Davidson has been previously linked to Ariana Grande, Kim Kardashian and more A-list celebrity women.',
      url: "https://www.foxnews.com/entertainment/pete-davidson-harassed-love-life-ugly-dating-hollywood-hot-girls",
      urlToImage:
        "https://static.foxnews.com/foxnews.com/content/uploads/2025/02/pete-davidson-ex.jpg",
      publishedAt: "2025-02-15T20:44:56Z",
      content:
        'Former "Saturday Night Live" star Pete Davidson is responding to the criticism hes received about his previous love life with A-list celebrity women.\r\nDavidson, 31, claimed hes been "harassed" about … [+3965 chars]',
    },
    {
      source: {
      ...
      title:
        "'Love Is Blind' season 8's Brittany blasts Devin for 'immature' reaction to her sexuality",
      description:
        "'Love Is Blind' season 8 cast member Brittany Dodson blasts Devin Buckley for his 'immature' reaction to her sexuality confession and calls him a 'little mama's boy.'",
      url: "https://ew.com/love-is-blind-season-8-brittany-blasts-devin-for-sexuality-response-11680526",
      urlToImage:
        "https://ew.com/thmb/eWO-lWWvT_-Eiq1_eIkffhcktDk=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/love-is-blind-brittany-021425-efab55b527c3457f85660c2bcf26b38a.jpg",
      publishedAt: "2025-02-15T20:07:19.756707Z",
      content:
        "Warning: This article contains spoilers about the first six episodes of Love Is Blind season 8.\r\nLove Is Blindseason 8 cast member Brittany Dodson has no regrets over ending things with her pod boyfr… [+6040 chars]",
    },
    {
      source: {
      ...
      urlToImage:
        "https://pyxis.nymag.com/v1/imgs/cc9/e5b/e70e59701490314fccf7546b819dff3bf5-loveisblind-s8-mason.1x.rsocial.w1200.jpg",
      publishedAt: "2025-02-15T13:00:05Z",
      content:
        "Mason, Madison, Megan, Molly people whose names start with an M were not lucky in love this season of Love Is Blind, huh? Now, Mason Horacek wasnt the only guy juggling a couple relationships in the … [+8400 chars]",
    },
    {
      source: {
        id: "new-york-magazine",
      ...
      description:
        "Love is in the air. Bill de Blasio has a new girlfriend and her name is Nomiki Konst, a political analyst and journalist 22 years his junior.",
      url: "https://www.thecut.com/article/who-is-bill-de-blasio-new-girlfriend.html",
      urlToImage:
        "https://pyxis.nymag.com/v1/imgs/869/109/a3d1978cf56f49a06a73a4e9fc20e4fffc-bill-deblasio-1.1x.rsocial.w1200.jpg",
      publishedAt: "2025-02-13T23:38:26Z",
      content:
        "Another New York bachelor has been taken off the market, and no, Im not talking about Marcello Hernandez. Im talking about former New York City mayor-turned-playboy Bill de Blasio. After he and his w… [+1296 chars]",
    },
    {
      source: {
        id: "football-italia",
      ...
      description:
        "The story began when Gigio Donnarumma followed his heart and signed with Milan and it could end with the club&#39;s return to the Champions League.",
      url: "http://www.football-italia.net/171170/donnarumma-and-milan-controversial-love-story",
      urlToImage:
        "https://ew.com/thmb/eWO-lWWvT_-Eiq1_eIkffhcktDk=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/love-is-blind-brittany-021425-efab55b527c3457f85660c2bcf26b38a.jpg",
      publishedAt: "2021-05-25T01:00:00Z",
      content:
  ...
  async componentDidMount() {
    // let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&apiKey=${this.props.apikey}&category=${this.props.category}&page=1&pageSize=${this.props.pageSize}`;
    // console.log(url);
    // try {
    //   this.setState({ loading: true });
    //   const response = await fetch(url);
  ...
  handlePreviousPage = async () => {
    // let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&apiKey=${this.props.apikey}&catagory=${this.props.category}&page=${this.state.page-1}&pageSize=${this.props.pageSize}`;
    // try {
    //     this.setState({loading:true})
    //     const response = await fetch(url);
    //     const data = await response.json();
    ...
    this.setState(
      ...
      this.updatePage
    ); // updatePage will be called once the state has updated
  };
  ...
  render() {
    return (
      <div className="container my-3">
        ...
        <h1>These are the top news for today on {this.props.category}</h1>
        <InfiniteScroll
          dataLength={this.state.articles.length}
          next={this.updateStateBeforeLoading}
